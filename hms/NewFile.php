...
<?php include('include/sidebar.php');?>
        ...
        <div class="col-sm-4">
          <input type="email" class="form-control inputstl" id="search" onkeyup="myFunction()" placeholder="Enter Your  Name">
        </div>
...
?>
	...
	<a href="manage-patients.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
