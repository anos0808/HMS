								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>
												<form role="form" name="dcotorspcl" method="post">
													<div class="form-group">
														...
														<input type="text" name="doctorpecilization" id="input"
															class="form-control"
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">
									Manage <span class="text-bold">Docter Specialization</span>
								</h5>
								<table class="table table-hover" id="tabledata">
									<thead>
										<tr>
											<th><a>Specialization</a> </th>
											<th class="hidden-xs"><a>Creation Date</a></th>
											<th><a>Updation Date</a></th>
											<th><a>Action</a></th>
										</tr>
									</thead>
									<tbody>
    ...
    ?>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs">
													<a
														href="edit-doctor-specialization.php?id=<?php echo $row['id'];?>"
														class="btn btn-warning btn-xs" tooltip-placement="top"
														tooltip="Edit"><i class="fa fa-pencil"></i></a> <a
														href="doctor-specilization.php?id=<?php echo $row['id']?>&del=delete"
